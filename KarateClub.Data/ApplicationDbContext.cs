...
public partial class ApplicationDbContext2 : DbContext
{
    ...
    public virtual DbSet<User> Users { get; set; } // إضافة مجموعة الـ Users

    // public virtual DbSet<MemberPersonBeltRankViewModel> MemberPersonBeltRankViewModels { get; set; }
      public virtual DbSet<SubscriptionPeriodMemberPersonBeltRankViewModel> MemberPersonBeltRankViewModels { get; set; }
    // public virtual DbSet<BeltTestBeltRankInstructorPaymentMemberPersonViewModel> MemberPersonBeltRankViewModels { get; set; }
    // public virtual DbSet<MemberInstructorPersonViewModel> MemberInstructorPersonViewModel { get; set; }
    // public virtual DbSet<MemberPersonBeltRankViewModel> MemberPersonBeltRankViewModel { get; set; }
    // public virtual DbSet<MemberInstructorPersonViewModel> MemberInstructorPersonViewModel { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.UserID) // تعيين المفتاح الأساسي
                  .HasName("PK_Users");

            entity.ToTable("Users"); // تعيين اسم الجدول

            entity.Property(e => e.UserID)
                  .ValueGeneratedOnAdd() // يتم إنشاء القيمة تلقائيًا عند الإضافة
